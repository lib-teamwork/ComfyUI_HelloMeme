...
class HelloFaceAlignment(object):
    def __init__(self, gpu_id=None):
        ...
        self.face_alignment_net_222 = create_onnx_session(get_juicefs_full_path_safemode(ComfyUI_HelloMeme_Mapping,"songkey--hello_group_facemodel/hello_face_landmark.onnx"), gpu_id=gpu_id)
        ...
        self.face_detector = HelloFaceDet(get_juicefs_full_path_safemode(ComfyUI_HelloMeme_Mapping,"songkey--hello_group_facemodel/hello_face_det.onnx"), gpu_id=gpu_id)
